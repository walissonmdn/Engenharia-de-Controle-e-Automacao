...
class Outlook:
        ...
        for _ in range(3):
            try:
                ...
                for message_index in messages_index[0].split():
                    ...
                    # Caso esteja especificado no assunto do e-mail que se trata de nota fiscal da KIA,
                    # baixar o xml.
                    if "documento electrnico" in subject.lower():
    ...
    def send_partial_report(self):
        ...
        message["Subject"] = f"RPA - Importação de XML - KIA"

        # Mensagem (HTML).
        html_message = f"""
            <div>
                <p>Olá!</p>
                <p>Segue em anexo a planilha com os resultados da importação dos arquivos de veículos da KIA.</p>
