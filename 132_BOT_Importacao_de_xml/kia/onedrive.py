...
class OneDrive:
    ...
    def get_page(self):
        ...
        self.selenium.get_page("https://saganet-my.sharepoint.com/:f:/r/personal/saga_rpa_gruposaga_com_br/Documents/132_BOT_Importacao_de_XML/KIA?csf=1&web=1&e=L4GTIY")
    ...
    def download_models_workbook(self):
        ...
        self.selenium.click("div[aria-label*='Mapeamento - KIA.xlsx'] > div:nth-child(1)")
        self.selenium.wait_for_element_to_appear("div[aria-label*='Mapeamento - KIA.xlsx'][aria-selected='true']")
